    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to.', related_name='notes_user_groups', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Sеpecific permissions for this user.', related_name='notes_user_permissions', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
